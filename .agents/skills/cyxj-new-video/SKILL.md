...
- 改 `index.html`：
  ...
  - 文件末尾 `window.__timelines["..."]` 同步改 id（AGENTS.md 第 4 条硬约束）
...
- **遇到 lint 报错**：参照仓库根 AGENTS.md "6 条硬约束"自查
- **中文转写绕开 hyperframes**：用 `whisper-cli`（AGENTS.md 已说明）
